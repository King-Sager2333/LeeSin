...
- **匹配模式**
- **极地大乱斗** - 支持英雄Buff信息显示
- **海克斯大乱斗** (ARAM Mayhem) - 自动识别队列、重随/备战席操作、出装与强化符文推荐
- **斗魂竞技场**
- **无限火力**
...
### 海克斯大乱斗
<img src="assets/mayhem.png" width="800" alt="海克斯大乱斗">
...
### 🔥 新增特性
1. **海克斯大乱斗支持**
   - 支持ARAM Mayhem模式（队列ID: 2400），自动同步到选人和出装页面
   - 支持重随、备战席换人、技能加点、ARAM符文/召唤师技能及装备推荐
   - 使用 ARAMGG 国服专属统计，出装源不可用时自动切换至 ARAM Mayhem 专属备用源，不再拼接普通 ARAM 与 Arena 数据
   - 外部攻略数据支持系统代理以及手动 HTTP、HTTPS、SOCKS4、SOCKS5 代理
...
### Q: 海克斯大乱斗模式怎么使用？
A: 进入海克斯大乱斗队列后，助手会自动识别队列并切换推荐模式。选人页可直接重随或交换备战席英雄，确定英雄后会自动打开对应推荐。
